      ...
      <footer className="bg-blue-50 dark:bg-gray-900 mt-5">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between items-center">
            <div className="mb-6 md:mb-0 flex items-center">
              <Link to="/" className="flex items-center">
                <img
                  ...
                  alt="Logo"
                  className="hidden xl:flex h-16 md:h-20 mr-4" // Adjusted height for responsiveness
                />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-6 xl:mx-0">
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <Link to="/about-dev" className="hover:underline">
                      About Dev
                    </Link>
                  </li>
                  <li>
                    <a
                      href="mailto:piyushgaur0001@gmail.com"
          ...
          <div className="sm:flex sm:items-center sm:justify-between ml-6 xl:ml-0">
